...
<title>Admin Login to Pan Myo Daw Yoghurt</title>
...
<body>
        ...
        <div class="register-container">
            <div class="register-box">
                ...
                <form method="post" action="AdminController">
                    <%@include file="additionalhtml/loginTable.html" %>
                    <input type='hidden' name="action" value='login'></input>
                </form>
                <p>
                    <span id="already-have-account">Don't have an account? </span> 
                    <a href="admin_register.jsp" id="to-login-link">Create Account</a>
                </p>
            </div>
    ...
    <div id="noAccountModal" class="modal">
        <div class="modal-content">
            ...
            <button class="continue-btn" onclick="window.location.href='admin_register.jsp'">Create Account</button>
            <br>

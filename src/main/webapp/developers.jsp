...
<head>
    ...
    <title>Developers' Info For Developers</title>
...
<%
    ...
    try {
        ...
        while (rs.next()) {
            ...
            String name = rs.getString("developer_name");
            System.out.println("Got the name " + name);
            String email = rs.getString("developer_email");
            System.out.println("Got the email " + email);
            String phone = rs.getString("developer_phone");
            System.out.println("Got the phone " + phone);
            String pass = rs.getString("developer_password");
            System.out.println("Got the password " + pass);
            String city = rs.getString("developer_city");
            System.out.println("Got the city " + city);
            byte[] profilePic = rs.getBytes("developer_profile_pic");
...
%>
            <tr>
                ...
                <td>
                    <form method="post" id="deleteDeveloperForm<%= id %>" action="DeleteDeveloperServlet" style="display:inline;">
                        <input type="hidden" name="id" value="<%= id %>">
                        <button type="submit" class="delete-button" onclick="checkPassword(event, 'deleteDeveloperForm<%= id %>')">Delete</button>
                    </form>
                </td>
            </tr>
<%
...
%>
        ...
        <div class="action-buttons">
            <form method="post" id="resetDeveloperForm" action="ResetDevelopers" style="display:inline;">
                <button type="submit" onclick="checkPassword(event, 'resetDeveloperForm')" value="Reset Table">Reset Table</button>
            </form>
    ...
    <div id="addForm">
        <form method="post" action="AddDeveloperServlet" id="addDeveloperForm" enctype="multipart/form-data">
            ...
            <div class="action-buttons">
                <button type="submit" onclick="checkPassword(event, 'addDeveloperForm')">OK</button>

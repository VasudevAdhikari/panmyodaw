...
<title>Employee Login to Pan Myo Daw Yoghurt</title>
...
<body>
        ...
        <div class="register-container">
            <div class="register-box">
                ...
                <p>
                    ...
                    <a href="emp_register.jsp" id="to-login-link">Create Account</a>
                </p>
            </div>
    ...
    <div id="noAccountModal" class="modal">
        <div class="modal-content">
            ...
            <button class="continue-btn" onclick="window.location.href='emp_register.jsp'">Create Account</button>
            <br>

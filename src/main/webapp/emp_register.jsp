...
<body>
	...
	<div class="container">
		...
		<div class="register-container">
			<div class="register-box">
				...
				<form id="registerForm" method="post" action="EmployeeController"
					...
					<table>
						<tr>
							...
							<td class="input-td"><input type="text" id="fullName"
								class="profile-input" name="employeeName" placeholder="John Doe"
								required></td>
						</tr>
						<tr>
							<td class="label-td"><label for="email" id="email-label">Gmail:</label></td>
							<td class="input-td"><input type="email" id="email"
								class="profile-input" name="employeeEmail"
								placeholder="something@something.com" required></td>
						</tr>
						<tr>
							<td class="label-td"><label for="password"
								id="password-label">Password :</label></td>
							<td class="input-td"><input type="password" id="password"
								class="profile-input" name="password" placeholder="Must have at least 6 characters"
								required minlength="6"></td>
						</tr>
						<tr>
							<td class="label-td"><label for="phone" id="phone-label">Phone
									:</label></td>
							<td class="input-td"><input type="tel" maxlength="11"
								minlength="7" id="phone" class="profile-input" name="phone"
								placeholder="09xxxxxxxxx" required></td>
						</tr>
						<tr>
							...
							<td class="input-td"><input type="file" id="profilePic"
								class="profile-input" required name="profilePic" accept="image/*"></td>
						</tr>
						<tr>
				...
				<p>
					<span id="already-have-profile">Already have a profile? </span> <a
						href="emp_login.jsp" id="to-login-link">Login</a>
				</p>
			</div>
		...
		<!--<div id="noAccountModal" class="modal">
			<div class="modal-content">
				...
				<button class="continue-btn"
					onclick="window.location.href='emp_login.jsp'">Login</button>
				<br>
	...
	document.getElementById("registerForm").addEventListener("submit", function(event) {
    	...
    	function tryAgain() {
    		...
    		window.location.href='emp_register.jsp';
    	}
